...
$(document).ready(function () {
    ...
    function pageLoad() {
        $('#notificationStoppedCoding').prop('checked', true);
        $('#notificationLangLevel').prop('checked', localStorage['notificationLangLevel'] === "true");
        $('#notificationStoppedCoding').prop('checked', localStorage['notificationStoppedCoding'] === "true");
        $('#notificationHourGained').prop('checked', localStorage['notificationHourGained'] === "true");
